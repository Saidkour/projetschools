      ...
      <div className="flex m-auto ">
        <div className="container mt-[100px] lg:mt-[150px]  px-10">
          ...
          <div className="text-semi-white mb-10 ">
            ...
            Welcome to our school management system! Discover how our comprehensive platform can streamline your school's operations and enhance student experiences.
            </p>
          </div>
          <div>
            <span className="bg-blue-500 mb-3 px-8 py-3 max-w-[150px] hover:bg-blue-200 ">
              <Link to="/login">
                <span className="font-medium text-semi-black">Get started</span>
              </Link>
            </span>
          </div>
          <div className="flex justify-between mb-3 mt-[100px] sm:mt-[150px] lg:mt-[200px]">
