  ...
  return (
    <div className="block min-w-full">
      <div className="m-auto flex justify-between min-w-[977px] p-2 bg-white rounded-md">
        <div>
          <h1 className="text-xl text-blue-600 font-bold p-2">ALL Student</h1>
        </div>
        <div>
          <div className="flex items-center p-2">
            <Link className="mr-3 text-lg text-gray-500" to={"/admin/dashboard/student"}>
              Student
            </Link>
            <svg
            ...
            <Link className="ml-3 text-lg text-blue-600" to={"/admin/dashboard/student"}>
              All Student
            </Link>
          </div>
        </div>
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              {students.map((student) => (
                <tr key={student.id} className="hover:shadow-sm">
                  <th
                    scope="row"
